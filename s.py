...
import requests
from streamlit_lottie import st_lottie  # Import for lottie animation
...
lottie_medical = load_lottie_url("https://assets3.lottiefiles.com/packages/lf20_bdlrkrqv.json")
